...
Error_Reporting(0);
	...
	$mysql_login			= "dios189_232";						// Логин к БД
	$mysql_password			= "232232232";							// Пароль к БД
	$database				= "dios189_232";						// База данных
	$num					= 10;							// Кол-во выводов на страницу
	$cfgURL					= "http://vinveste.ru/";						// URL ресурса
