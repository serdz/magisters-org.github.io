	...
	if($ref) {
		...
		$row4 			= mysql_fetch_array($get_user_info4);
		 $upskype	= $row4['skype'];
			...
			print "<p>Вас пригласил: <b>".$uplogin." </b> Вы принесли ему: <b>".$ref_money." RUB </b></p>";}
		if($upicq) {
...
<table width="100%">
	<tr align="center">
		<td><input type="text" name="refurl" style="width: 100%;" value="<?php print $cfgURL; ?>?ref=<?php print $login; ?>" /></td>
	</tr>
</table>
...
<LEGEND><b>Рекламные баннеры:</b></LEGEND>


<a href="<?php print $cfgURL; ?>?ref=<?php print $login; ?>" target="_blank"><img src="<?php print $cfgURL; ?>468.gif"/> </a>
<br>
<br>Код баннера 468х60:<br>
<textarea>
<a href="<?php print $cfgURL; ?>?ref=<?php print $login; ?>" target="_blank"><img src="<?php print $cfgURL; ?>468.gif"/> </a>
</textarea>
...
<a href="<?php print $cfgURL; ?>?ref=<?php print $login; ?>" target="_blank"><img src="<?php print $cfgURL; ?>200.gif"/> </a>
<br>
<br>Код баннера 200х300:<br>
<textarea>
<a href="<?php print $cfgURL; ?>?ref=<?php print $login; ?>" target="_blank"><img src="<?php print $cfgURL; ?>200.gif"/> </a>
</textarea>
...
<a href="<?php print $cfgURL; ?>?ref=<?php print $login; ?>" target="_blank"><img src="<?php print $cfgURL; ?>100.gif"/> </a>
<br>
<br>Код баннера 100х100:<br>
<textarea>
<a href="<?php print $cfgURL; ?>?ref=<?php print $login; ?>" target="_blank"><img src="<?php print $cfgURL; ?>100.gif"/> </a>
</textarea>
