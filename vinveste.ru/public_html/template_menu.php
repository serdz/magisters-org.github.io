...
#topmenu_wrap {
	...
	background: #272727; /* Old browsers */
	background: -moz-linear-gradient(top,  #272727 0%, #1a5c7f 100%); /* FF3.6+ */
	background: -webkit-gradient(linear, left top, left bottom, color-stop(0%,#272727), color-stop(100%,#1a5c7f)); /* Chrome,Safari4+ */
	background: -webkit-linear-gradient(top,  #272727 0%,#1a5c7f 100%); /* Chrome10+,Safari5.1+ */
	background: -o-linear-gradient(top,  #272727 0%,#1a5c7f 100%); /* Opera 11.10+ */
	background: -ms-linear-gradient(top,  #272727 0%,#1a5c7f 100%); /* IE10+ */
	background: linear-gradient(top,  #272727 0%,#1a5c7f 100%); /* W3C */
	filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#272727', endColorstr='#1a5c7f',GradientType=0 ); /* IE6-8 */
}
...
#topmenu_wrap {
	-pie-background: linear-gradient(#272727, #1a5c7f);
	behavior: url(/business/templates/hot_business/css/PIE.php);
}
</style>
<![endif]-->
